    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('food_unit_cost', models.DecimalField(decimal_places=2, default=2000, max_digits=8, verbose_name='Costo unitario del alimento (COP)')),
                ('hygiene_unit_cost', models.DecimalField(decimal_places=2, default=2000, max_digits=8, verbose_name='Costo unitario de la higiene (COP)')),
