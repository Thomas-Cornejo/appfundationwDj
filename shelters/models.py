...
class Shelter(models.Model):
    ...
    hygiene_unit_cost = models.DecimalField(
        max_digits=8,
        decimal_places=2,
        default=2000,
        verbose_name="Costo unitario de la higiene (COP)",
    )
    food_degradation_hours = models.SmallIntegerField(
        default=8, verbose_name="Horas para degradacion del alimento"
    )
    food_degradation_percentage = models.SmallIntegerField(
        default=10, verbose_name="Porcentaje de degradacion del alimento"
    )
    hygiene_degradation_hours = models.SmallIntegerField(
        default=24, verbose_name="Horas para degradacion de la higiene"
    )
    hygiene_degradation_percentage = models.SmallIntegerField(
        default=10, verbose_name="Porcentaje de degradacion de la higiene"
    )
